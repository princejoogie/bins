...
function Game:set_globals()
    ...
    --||||||||||||||||||||||||||||||
    self.TILESIZE = 50 -- 20
    self.TILESCALE = 5.65 -- 3.65
    self.TILE_W = self.F_MOBILE_UI and 11.5 or 21 -- 20
    self.TILE_H = self.F_MOBILE_UI and 20 or 11.5 -- 11.5
    self.DRAW_HASH_BUFF = 2
    self.CARD_W = 2.7*35/41 -- 2.4*35/41
    self.CARD_H = 2.7*47/41 -- 2.4*47/41
    self.HIGHLIGHT_H = 0.2*self.CARD_H
    self.COLLISION_BUFFER = 0.03 -- 0.05
